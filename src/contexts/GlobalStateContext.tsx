...
export function GlobalStateProvider({ children }: { children: ReactNode }) {
  ...
  const invalidateCategories = useCallback(() => {
    console.log('🔄 GlobalState: Invalidating categories and dependent data');
    setState(prev => ({
      ...prev,
  ...
  const invalidateTopics = useCallback(() => {
    console.log('🔄 GlobalState: Invalidating topics and dependent data');
    setState(prev => ({
      ...prev,
      topicsNeedRefresh: true,
      lastTopicUpdate: Date.now(),
  ...
  const invalidateQuestions = useCallback(() => {
    console.log('🔄 GlobalState: Invalidating questions and dependent data');
    setState(prev => ({
      ...prev,
      questionsNeedRefresh: true,
      lastQuestionUpdate: Date.now(),
  ...
  const invalidateDashboard = useCallback(() => {
    console.log('🔄 GlobalState: Invalidating dashboard');
    setState(prev => ({
      ...prev,
      dashboardNeedsRefresh: true
    }));
  ...
  const invalidateUserStats = useCallback(() => {
    console.log('🔄 GlobalState: Invalidating user stats and dashboard');
    setState(prev => ({
      ...prev,
  ...
  const invalidateAll = useCallback(() => {
    console.log('🔄 GlobalState: Invalidating ALL data');
    setState({
      categoriesNeedRefresh: true,
      topicsNeedRefresh: true,
      questionsNeedRefresh: true,
